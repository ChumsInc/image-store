...
export const SET_DEFAULT_IMAGE_PATH = 'SET_DEFAULT_IMAGE_PATH';
export const SET_FILTER = 'SET_FILTER';
export const SET_FILTER_INACTIVE = 'SET_FILTER_INACTIVE';
export const SET_FILTER_UNASSIGNED = 'SET_FILTER_UNASSIGNED';
export const SET_IMAGE_FILTER = 'SET_IMAGE_FILTER';
export const SET_IMAGES_PER_PAGE = 'SET_IMAGES_PER_PAGE';
export const SET_ITEM_BASE_SKU = 'SET_ITEM_BASE_SKU';
